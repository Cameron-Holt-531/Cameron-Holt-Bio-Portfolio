...
At KSDT, I designed and deployed numerous automations that significantly reduced manual effort and improved operational efficiency across departments.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Power Automate (Cloud & Desktop), Copilot Studio, N8N, Postman</td>
    </tr>
    <tr>
...
<table border="1" cellpadding="6" cellspacing="0">
  ...
  <tbody>
    <tr>
      <td><a href="https://github.com/Cameron-Holt-531/CSV-Reader">CSV Data Staging Tool</a></td>
      <td>Engineered a web-based ETL tool for ERP data staging</td>
      <td>Python, Streamlit, Pandas, GitHub CI/CD</td>
      <td>Built a CSV viewer/editor that allows users to modify data, fix formatting issues (like leading zeros), and download cleaned files for ingestion.</td>
    </tr>
     <tr>
      <td>Programmable Crawler Robot</td>
      <td>Built a physical quadruped robot using a Raspberry Pi</td>
      <td>Python, Raspberry Pi, Linux, Hardware</td>
      <td>Wrote Python scripts to control servo movement and managed the Linux environment to execute automated physical actions.</td>
    </tr>
  </tbody>
</table>
